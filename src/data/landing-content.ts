...
export const landingContent: LandingContent = {
  ...
  intro: {
    ...
    paragraphs: [
      ...
      "當然，大部分的內容都是由 AI 助理所產生的。您可以探索以下領域：",
      "1. AI 與語言系統：整合自然語言處理技術的跨語言翻譯平台與各類規格文件翻譯專案。",
      "2. 高效實用工具：包含 PDF 拆分合併、PDF 轉 PPTX 等提升工作效率的線上小幫手。",
      "3. 互動遊戲體驗：提供五子棋、踩地雷等經典遊戲的網頁版實作。",
      "4. 技術觀點與連結：彙整我在 Vocus 的專欄文章、GitHub 開源專案以及各大社群媒體的動態。",
    ],
    note: "當然",
  },
  sections: [
